...
export function QuranValleyZone() {
  ...
  const categories = [
    { id: 'quran', name: 'Quranic Verses', icon: '📖', color: 'from-blue-500 to-indigo-600' },
    { id: 'tafsir', name: 'Meaning & Tafsir', icon: '💡', color: 'from-indigo-500 to-purple-600' },
    { id: 'memorization', name: 'Memorization', icon: '🧠', color: 'from-purple-500 to-pink-600' },
    { id: 'stories', name: 'Quranic Stories', icon: '📚', color: 'from-blue-600 to-indigo-700' }
  ];
  ...
  const handleStartQuest = (difficulty: 'easy' | 'medium' | 'hard') => {
    navigate(`/kid/adventure-zones/quran-valley/play`, {
      state: { 
        difficulty,
        zone: 'quran-valley',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100 pb-20">
      {/* Header */}
      <div className="relative bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-8 shadow-2xl overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-5xl font-bold mb-2 drop-shadow-lg">Quran Valley</h1>
              <p className="text-2xl opacity-90">وادي القرآن</p>
            </div>
          </div>

          <p className="text-lg mb-6 bg-white/10 backdrop-blur-sm rounded-lg p-4">
            A sacred valley filled with divine wisdom! Explore beautiful ayahs,
            learn their meanings, and discover the timeless stories of the Quran.
          </p>
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <Card className="border-4 border-blue-400">
          <CardHeader>
            ...
            <CardDescription className="text-base">
              Discover the divine wisdom of Allah's final revelation
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl p-6 text-white text-center">
          ...
          <h3 className="text-xl font-bold mb-2">Recite & Reflect!</h3>
          <p className="opacity-90">
            The Quran is a guide for all mankind. Every ayah you learn brings you
            closer to Allah's wisdom. Bismillah! 🤲✨
          </p>
        </div>
      </div>
    </div>
